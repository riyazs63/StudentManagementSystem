		...
		<form action="<%=request.getContextPath()%>/list" method="post"
			...
			<div class="input-group">
				<input type="text" class="form-control"
					placeholder="Search by Name, Email, or City" name="keyword"
			...
			<tbody>
				...
				<a:forEach items="${display}" var="u">
					...
					<tr>
						...
						<td><a href="edit?id=<a:out value="${u.id }"></a:out>">EDIT</a>&nbsp;&nbsp;<a
							href="delete?id=<a:out value="${u.id }"></a:out>">DELETE</a></td>
					</tr>
				</a:forEach>

				<a:if test="${empty display}">
					<tr>
